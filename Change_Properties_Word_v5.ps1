...
class Word {
    ...
    [void]GetDocumentProperties() {
        $properties = @{
            Author               = $this.Document.BuiltInDocumentProperties("Author").Value
            Title                = $this.Document.BuiltInDocumentProperties("Title").Value
            Subject              = $this.Document.BuiltInDocumentProperties("Subject").Value
            Keywords             = $this.Document.BuiltInDocumentProperties("Keywords").Value
            Category             = $this.Document.BuiltInDocumentProperties("Category").Value
            Comments             = $this.Document.BuiltInDocumentProperties("Comments").Value
            RevisionNumber       = $this.Document.BuiltInDocumentProperties("RevisionNumber").Value
            Version              = $this.Document.BuiltInDocumentProperties("Version").Value
        }
