class Word {
    ...
    [object]$PC
    [psCustomObject]$ImageHandler
    [psCustomObject]$TableHandler
    ...
    Word([string]$filePath, [object]$pc) {
        ...
        $this.ImageHandler = [psCustomObject]::new($this.Document)
        $this.TableHandler = [psCustomObject]::new($this.Document)
    }
