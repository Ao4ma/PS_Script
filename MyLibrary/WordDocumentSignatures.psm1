function Fill_Signatures {
    ...
    $cell1.Range.Font.Size = 14
    $cell1.Range.Paragraphs[2].Range.Font.Size = 10 # 日付のフォントサイズを8に設定

    $cell2.Range.Text = "$承認者`n$承認者日付"
    $cell2.Range.ParagraphFormat.Alignment = 1  # wdAlignParagraphCenter
    $cell2.Range.Font.Size = 14
    $cell2.Range.Paragraphs[2].Range.Font.Size = 10 # 日付のフォントサイズを8に設定

    $cell3.Range.Text = "$照査者`n$照査者日付"
    $cell3.Range.ParagraphFormat.Alignment = 1  # wdAlignParagraphCenter
    $cell3.Range.Font.Size = 14
    $cell3.Range.Paragraphs[2].Range.Font.Size = 10 # 日付のフォントサイズを8に設定
